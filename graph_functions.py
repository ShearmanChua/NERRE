...
import time
import pandas as pd
from inference import do_everything, generate_neo4j_dfs
...
if __name__ == "__main__":
    ...
    linked_entities, relations = do_everything(dataset)
    node_df, relation_df, triple_df = generate_neo4j_dfs(relations, 'wiki80_rel2id.json', linked_entities)
